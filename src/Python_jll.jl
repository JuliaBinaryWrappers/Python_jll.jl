...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Python_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("93d3a430-8e7c-50da-8e8d-3dfcfb3baf05"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Python", artifacts_toml) for e in artifacts["Python"]]
...
if best_platform === nothing
    @debug("Unable to load Python; unsupported platform $(triplet(platform_key_abi()))")
else
